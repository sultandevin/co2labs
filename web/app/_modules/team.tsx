...
const ProfileCard = (props: (typeof TEAM_MEMBERS)[number]) => (
  <div className="relative flex flex-col items-center gap-1 rounded-xl bg-white p-6 text-center transition-all lg:mt-20 lg:pt-24 lg:shadow-lg lg:hover:scale-110 hover:lg:shadow-2xl">
